...
ExecStart=/usr/local/bin/cloud_sql_proxy -dir=/var/run/cloud-sql-proxy -instances=bdbr-sql-proxy-svc-e976:europe-west1:bdbr-sql-instance=tcp:0.0.0.0:5432 -enable_iam_login
Restart=always
