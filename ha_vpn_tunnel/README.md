...
#### Debian image
Use a datablock to get the URL to the image, if necessary.  An alternative, if your organisation has limited the projects where you can use images from, you'll have to update this block (or replace it with something else).
